...
test('release rejects invalid identifiers and accepts production inventory', () => {
...
test('Expo config consumer refuses preview, production, and local production builds without live IDs', () => {
